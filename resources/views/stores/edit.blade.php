                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <div class="form-check form-switch d-flex justify-content-center">
                                                ...
                                                <input class="form-check-input" type="checkbox" id="mercadoPagoSwitch"
                                                    name="accepts_mercadopago" value="1"
                                                    {{ $store->mercadoPagoAccount ? 'checked' : '' }}>
                                            </div>
                                            <!-- Campos MercadoPago (ocultos por defecto) -->
                                            <div id="mercadoPagoFields" class="integration-fields"
                                                style="display: none;">
                                                <div class="mb-3">
                                                    <label class="form-label mt-2" for="mercadoPagoPublicKey">Public
                                                        Key</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        id="mercadoPagoAccessToken" name="mercadoPagoAccessToken"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="mercadoPagoSecretKey"
                                                        ...
                                                        placeholder="Secret Key de MercadoPago"
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <div class="form-check form-switch d-flex justify-content-center">
                                                ...
                                                <input class="form-check-input" type="checkbox" id="peyaEnviosSwitch"
                                                    name="accepts_peya_envios" value="1"
