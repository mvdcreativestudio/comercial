...
@section('title', 'Detalle Asiento Contable')
    ...
    <div class="card-body">
      <div class="d-flex justify-content-between">
        ...
        <div class="mb-3 col-2">
          ...
          <input class="form-control" type="text" value="{{ $entry->template ?? 'Sin Plantilla' }}" id="template"
            disabled>
        </div>
        <div class="mb-3 col-1">
        ...
        <div class="mb-3">
          ...
          <input class="form-control" type="text" value="{{ $entry->exchange_rate ?? 'N/A' }}" id="exchangeRate"
            disabled>
        </div>
      </div>
